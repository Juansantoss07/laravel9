...
Route::post('/finalizar-compra/{produtos}/{quantidades}', [CarrinhoController::class, 'finalizaCarrinho'])->name('site.finalizaCarrinho');
...
Route::put('/admin/produto/update/{id}', [ProdutoController::class, 'update'])->name('admin.produtos.update');
...
Route::post('/checkout/concluido/{produtos}/{quantidades}', [CheckoutController::class, 'enviaPagamento'])->name('checkout.enviaPagamento');
